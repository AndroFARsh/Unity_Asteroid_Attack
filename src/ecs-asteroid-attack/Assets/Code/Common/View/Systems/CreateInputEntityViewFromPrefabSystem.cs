...
{
  public class CreateInputEntityViewFromPrefabSystem : IExecuteSystem
  {
    ...
    public CreateInputEntityViewFromPrefabSystem(InputContext input, IEntityViewFactory entityViewFactory)
    {
      _entityViewFactory = entityViewFactory;
      _entities = input.GetGroup(InputMatcher
        .AllOf(InputMatcher.ViewPrefab)
