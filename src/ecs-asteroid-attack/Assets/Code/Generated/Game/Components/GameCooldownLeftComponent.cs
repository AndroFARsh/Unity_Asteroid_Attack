...
public partial class GameEntity {
    ...
    public Code.Game.Cooldowns.CooldownLeftComponent cooldownLeft { get { return (Code.Game.Cooldowns.CooldownLeftComponent)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.Game.Cooldowns.CooldownLeftComponent)CreateComponent(index, typeof(Code.Game.Cooldowns.CooldownLeftComponent));
