...
public partial class GameEntity {
    ...
    public Code.Game.Player.VelocityComponent velocity { get { return (Code.Game.Player.VelocityComponent)GetComponent(GameComponentsLookup.Velocity); } }
    ...
    public GameEntity AddVelocity(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Game.Player.VelocityComponent)CreateComponent(index, typeof(Code.Game.Player.VelocityComponent));
