...
public partial class GameEntity {
    ...
    public Code.Game.Common.LayerMaskComponent layerMask { get { return (Code.Game.Common.LayerMaskComponent)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Code.Game.Common.LayerMaskComponent)CreateComponent(index, typeof(Code.Game.Common.LayerMaskComponent));
